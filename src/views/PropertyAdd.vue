...
<template>
    <div class="container py-3">
        ...
        <div v-if="propertyTypesLoaded" class="row">
            <div class="col-md-6">
                <form ref="form" @submit.prevent="addProperty()" class="needs-validation" novalidate>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" ref="file" accept="image/*" required>
                        <div class="invalid-feedback">
